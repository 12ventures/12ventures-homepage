...
import ExportRangeModal, { type CallsExportRange } from './ExportRangeModal';
...
const OperatorDashboard: React.FC = () => {
  ...
  const handleDownload = useCallback(async (range: CallsExportRange) => {
    setShowExportRange(false);
    setDownloading(true);
    ...
    <div className={`od-root${revealed ? ' od-root--revealed' : ''}`}>
      ...
      <div className="od-header od-reveal" style={odReveal(0)}>
        ...
        <div className="od-header-actions">
          ...
          <div className="od-export-wrap" ref={exportWrapRef}>
            <button
              type="button"
            ...
            {showExportRange ? (
              <ExportRangeModal
                ...
                onChoose={(range) => void handleDownload(range)}
              />
            ) : null}
          </div>
        </div>
      ...
      <div className="od-metrics-grid">
        ...
        <div className="od-metric-card od-reveal" style={odReveal(6)}>
          ...
          <div className="od-metric-value od-metric-value-sm">
            <AnimatedNumber value={totalMinutes} decimals={1} delay={countAnimDelay(6)} />
            {' '}
