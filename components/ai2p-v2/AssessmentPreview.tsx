...
const AssessmentPreview: React.FC = () => (
  <aside className="ai2p-v2-preview-shell" aria-label="Sample assessment preview">
    <div className="ai2p-v2-preview-top">
      <div>
    ...
    <div className="ai2p-v2-preview-kpis">
      <div className="ai2p-v2-preview-kpi">
    ...
    <div className="ai2p-v2-preview-body">
      <article className="ai2p-v2-finding">
        <div className="ai2p-v2-finding-top">
          <span className="ai2p-v2-badge ai2p-v2-badge-high">HIGH</span>
          <span className="ai2p-v2-badge">F-04</span>
        </div>
      ...
      <article className="ai2p-v2-finding">
        <div className="ai2p-v2-finding-top">
          <span className="ai2p-v2-badge ai2p-v2-badge-high">HIGH</span>
          <span className="ai2p-v2-badge">F-05</span>
        </div>
      ...
      <article className="ai2p-v2-finding">
        <div className="ai2p-v2-finding-top">
          <span className="ai2p-v2-badge ai2p-v2-badge-med">MEDIUM</span>
          <span className="ai2p-v2-badge">F-12</span>
        </div>
