...
Pretty share links (`https://www.12ventures.io/haven/store/...`) need Amplify reverse-proxy + API SPA-shaped OG HTML. Step-by-step: [`hosting/SHARE_OG.md`](hosting/SHARE_OG.md). Rewrite JSON: [`hosting/amplify-custom-rules.json`](hosting/amplify-custom-rules.json).
